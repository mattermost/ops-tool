...
# LDFLAGS
GO_LDFLAGS                   += -X "github.com/${GITHUB_ORG}/${APP_NAME}/version.commitHash=$(APP_COMMIT)"
GO_LDFLAGS                   += -X "github.com/${GITHUB_ORG}/${APP_NAME}/version.version=$(APP_VERSION)"
GO_LDFLAGS                   += -X "github.com/${GITHUB_ORG}/${APP_NAME}/version.buildDate=$(BUILD_DATE)"
GO_LDFLAGS                   += -X "github.com/${GITHUB_ORG}/${APP_NAME}/service.goVersion=$(GO_VERSION)"
